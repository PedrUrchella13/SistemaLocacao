...
namespace SistemaLocacao.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmeId,Titulo,Genero,AnoLancamento,Diretor,Preco,Estudio,Distribuidora,Disponivel,ClienteId")] Filme filme)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Set<Cliente>(), "ClienteId", "ClienteId", filme.ClienteId);
            return View(filme);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmeId,Titulo,Genero,AnoLancamento,Diretor,Preco,Estudio,Distribuidora,Disponivel,ClienteId")] Filme filme)
        {
            if (id != filme.FilmeId)
            {
                return NotFound();
